...
!function(){"use strict";function coreMenu(Menus){Menus.addMenuItem("sidebar",{title:"Challenges",state:"app.form",type:"dropdown",iconClass:"icon-note",position:5,roles:["*"]}),Menus.addSubMenuItem("sidebar","app.form",{title:"Join a Challenge",state:"app.form-extended"}),Menus.addSubMenuItem("sidebar","app.form",{title:"Create a Challenge",state:"app.form-validation"})}angular.module("app.forms").run(coreMenu),coreMenu.$inject=["Menus"]}();
...
!function(){"use strict";function coreMenu(Menus){Menus.addMenuItem("sidebar",{title:"National Leaderboard",state:"app.table",type:"dropdown",iconClass:"icon-grid",position:7,roles:["*"]}),Menus.addSubMenuItem("sidebar","app.table",{title:"Most Fit Companies",state:"app.table-ngtable"})}angular.module("app.tables").run(coreMenu),coreMenu.$inject=["Menus"]}();
